...
export const sampleRecords: SampleRecord[] = [
  ...
  {
    usn: "1DS21AI400",
    fullName: "MOHAMMED SAMIULLA KHAN",
    batchYear: 2021,
    semester: 4,
    companyName: "Garuda Bhive Workspace",
    roleTitle: "Frontend Developer Intern",
    stipend: "-",
    startDateRaw: "04-01-2024",
    endDateRaw: "05-04-2024",
    durationText: "3 months",
    grade: "A",
    status: "Completed",
    relevantPOs: "PO1,3,5,9,10,12",
    relevantPSOs: "PSO1",
    coMappingSummary: "Frontend development aligned with system design and delivery outcomes.",
  },
];
